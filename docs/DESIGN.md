...
> **Note:** Currently this is a copy of Open Food Facts explorer DESIGN.md file, we may decide in the future if we do somethings different, or stay the same.
...
### Good Examples from the Explorer Codebase
