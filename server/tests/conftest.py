...
def agribalyse_index():
    ...
    Each row carries a ``score`` (the EF score, in mPt/kg) so the EF-score
    computation can be exercised. ``Carrot`` is only reachable through the
    Ciqual column to mirror the fallback code path.
    """
    by_code = {
        "10001": {"code": "10001", "ciqual_code": "20001", "name_fr": "Apple", "score": 0.3},
        "10002": {"code": "10002", "ciqual_code": "20002", "name_fr": "Pear", "score": 0.5},
    }
    by_ciqual = {
        "20001": by_code["10001"],
        "20002": by_code["10002"],
        "30000": {"code": "10003", "ciqual_code": "30000", "name_fr": "Carrot", "score": 0.2},
    }
